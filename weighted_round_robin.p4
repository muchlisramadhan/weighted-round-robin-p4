...
control ingress(inout headers hdr, inout metadata meta, inout standard_metadata_t standard_metadata) {
	...
	meta.mymetadata.lower=1;
	meta.mymetadata.upper=w1+w2+w3+w4;
        random(meta.mymetadata.result, meta.mymetadata.lower, meta.mymetadata.upper);
    }
    ...
    apply {
	    ...
	    set_weight.apply();
	    if(meta.mymetadata.result<=meta.mymetadata.weight1){
	  	meta.mymetadata.ecmp_select=1;
            } else if ((meta.mymetadata.result>meta.mymetadata.weight1) && (meta.mymetadata.result<=(meta.mymetadata.weight1+meta.mymetadata.weight2))){
		meta.mymetadata.ecmp_select=2;
	    } else if ((meta.mymetadata.result>(meta.mymetadata.weight1+meta.mymetadata.weight2)) && (meta.mymetadata.result<=(meta.mymetadata.weight1+meta.mymetadata.weight2+meta.mymetadata.weight3))){
		meta.mymetadata.ecmp_select=3;
	    } else if ((meta.mymetadata.result>(meta.mymetadata.weight1+meta.mymetadata.weight2+meta.mymetadata.weight3)) && (meta.mymetadata.result<=(meta.mymetadata.weight1+meta.mymetadata.weight2+meta.mymetadata.weight3+meta.mymetadata.weight4))){
